# ALEX POTER [FULL CV HERE](https://htmlpreview.github.io/?https://github.com/alxptr/cv/blob/master/index.html?env=http://datatables.org/alltables.env)  
...
| ![logo](scheme/project23/logo.png) | [**SweedPos [ex WALLI IT, INC] [Start-up]**](https://sweedpos.com/)                                                               |
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| Project                            | **[#23  Customizable web-based digital kiosks applications, the main entry points for all in-store customers](scheme/project23)** |
| Contract position                  | **Tech Lead / Team Lead / Lead Front-End Engineer**                                                                               |
| Role                               | **Team Lead / Tech Lead [ in a team of up to 3 front-end developers ]**                                                           |
| Project activities                 | **[ February 2023 ➜ March 2025 ]**                                                                                                |
| Tech Stack                         | TypeScript 5, React 18 [Class Components], Redux, InversifyJS, Webpack 5                                                          |
| Contract Period                    | [ 7 years 9 months ] [ July 2017 ➜ March 2025 ]                                                                                   |
| Working schedule                   | Full-time / Long-term contract / Hybrid                                                                                           |

| ![logo](scheme/project22/logo.png) | [**SweedPos [ex WALLI IT, INC] [Start-up]**](https://sweedpos.com/)                                                   |
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
...
| Tech Stack                         | TypeScript 2, Bluebird, InversifyJS                                                                                                          |
| Contract Period                    | [ 1 year 10 months ] [ March 2015 ➜ December 2016 ]                                                                                          |
| Working schedule                   | Full-time / Long-term contract / Onsite                                                                                                      |

| ![logo](scheme/project07/logo.png) | [**IMIGO.ME Limited [Start-up]**](https://www.youtube.com/watch?v=4ZSbEMNb3tw)  |
|------------------------------------|---------------------------------------------------------------------------------|
...
| Tech Stack                         | JavaScript ES6, Babel, AngularJS, jQuery                                        |
...
| Tech Stack                         | JavaScript ES5, ExtJS 5, Google Closure, Java                          |
...
|------------------------------------|------------------------------------------------------------------------------------------------------------|
| Project                            | **[#3  For payment kiosks: «Provider Visibility» module v1.0, the payment system core](scheme/project03)** |
| Contract position                  | **Junior Programmer ➜ Lead Programmer**                                                                    |
| Role                               | **Principal Full-Stack Developer Role [ a team of 1 full-stack expert ]**                                  |
| Project activities                 | **[ January 2011 ➜ July 2011 ]**                                                                           |
| Tech Stack                         | JavaScript, ExtJS 3, Java, SQL, Oracle                                                                     |
